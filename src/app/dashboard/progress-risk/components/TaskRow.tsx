 ...
 *
 * 초보자 가이드:
 * 1. **행 구조**: 인덱스, 코드, 이름, 날짜, 단계(StageStepper), 선행, 담당자, 상태, 메뉴
 * 2. **담당자**: assignees 배열의 user.name 표시 (쉼표로 구분)
 * 3. **선행**: predecessorId로 이전 task 찾아 코드 표시
 * 4. **StageStepper**: 9 dot 진행 바로 클릭 시 단계 변경
 */
"use client";

import type { ProgressTask } from "@/lib/api";
import { StageStepper } from "./StageStepper";
import { useUpdateProgressTask } from "@/hooks/useProgressTasks";
