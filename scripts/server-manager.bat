...
echo  ║   [3] ecosystem.config.js 생성                                ║
echo  ║   [4] logs 폴더 생성                                          ║
echo  ║   [5] PM2 앱 최초 등록 및 저장                                ║
echo  ║   [A] 전체 자동 설치 (1-5 모두 실행)                          ║
echo  ║                                                               ║
echo  ║   [0] 메인 메뉴로                                             ║
echo  ║                                                               ║
echo  ╚═══════════════════════════════════════════════════════════════╝
...
if "%choice%"=="3" goto PM2_CREATE_ECOSYSTEM
...
:PM2_CREATE_ECOSYSTEM
echo.
echo  [INFO] ecosystem.config.js 생성 중...
(
echo module.exports = {
echo   apps: [
echo     {
...
echo       error_file: "%PROJECT_PATH:\=\\%\\logs\\error.log",
echo       out_file: "%PROJECT_PATH:\=\\%\\logs\\out.log",
...
echo.
echo  [DONE] ecosystem.config.js 생성 완료!
echo  [PATH] %PROJECT_PATH%\ecosystem.config.js
pause
goto PM2_SETUP_MENU
...
call npm install -g pm2
echo.
echo  [2/5] PM2 Windows Startup 설치...
call npm install -g pm2-windows-startup
call pm2-startup install
echo.
echo  [3/5] ecosystem.config.js 생성...
(
echo module.exports = {
echo   apps: [
echo     {
